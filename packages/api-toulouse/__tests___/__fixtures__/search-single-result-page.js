...
<META HTTP-EQUIV="REFRESH" CONTENT="500 ;URL=/web2/tramp2.exe/log_out/A02plcce.001?server=1home&item=1">
...
<div class="surbandeau">
		<div class="conteneur">
		<a class="home" href="/web2/tramp2.exe/goto/A02plcce.001?screen=Home.html">
		</a>
		...
		<div class="recherche">
			<form class="quicksearch" name="QEntry" action="/web2/tramp2.exe/form/A02plcce.001" METHOD="post" enctype="application/x-www-form-urlencoded">
				<span>
				<input type="hidden" name="servers" value="1home">
				<input type="hidden" name="query_screen" value="Home.html">
				<input class="requete" placeholder="Rechercher dans le catalogue" type="text" size="28" maxlength="255" name="query" size="30" value="9782355743535">
...
<INPUT TYPE=SUBMIT NAME="recherche_bandeau" class=topsearch VALUE="">
	...
	<div class="mmenu">
		<div class="mmenu-conteneur">
				<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=PowerSearch.html">
					<span>
					Recherche avancée
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=ALL_New.html">
					<span>
					Nouveautés
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=ALL_have_read.html">
					<span>
					Sélections
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=ALL_oeil.html">
					<span>
					Handicap
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=Ress_Num.html">
					<span>
					24H/24H
					</span>
				</a>
				...
				<a class="moncompte" href="/web2/tramp2.exe/goto/A02plcce.001?screen=MyAccount.html">
					<span>
					Mon compte
					</span>
				</a>
...
<tbody><tr><td align="center">
			...
			<img src="/html/BMT1_iFiles/Graphics/babelio/arrow_left_2.gif" alt="" border="0">
					...
					<A HREF="/web2/tramp2.exe/see_hits/A02plcce.001?server=1home#1">

					<img src="/html/BMT1_iFiles/Graphics/babelio/refresh.gif" alt="Voir la liste" hspace="2" border="0"></a>

<a href="/web2/tramp2.exe/get_query/A02plcce.001"><img src="/html/BMT1_iFiles/Graphics/babelio/lupe.gif" alt="Modifier la Recherche" border="0"></a>
...
<div id="isbn_livre">
<span style="display:none;">9782355743535</span>
</div>
...
<!-- TITELIVE-->
	...
	<!--<img src="http://images.titelive.com/535/9782355743535_1_75.jpg" width="200"  border="0" align="center" style="border: 1px solid #cccccc; padding: 5px;"><br>-->
...
<a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Sundberg%2C+Minna" onMouseOver="window.status='Recherche par auteur'; return true">
<img src="/html/BMT1_iFiles/Graphics/babelio/search_auteur.gif" alt="du meme auteur" border="0"></a>
	  ...
	  <input name="" type="text" value="http://catalogues.toulouse.fr/web2/tramp2.exe/do_keyword_search/log_in?setting_key=BMT1&servers=1home&query=ELC5208543&screen=hitlist.html">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	Stand still stay silent 1 /<br>

	</h1>

	<div id="auteur">de <a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Sundberg%2C+Minna&screen=hitlist.html">Sundberg, Minna</a>
...
<table valign="top" width="98%"><tbody>
	...
	<h2>Résumé</h2>
	<p>
	Une équipe d'explorateurs nordiques se lance dans la première mission officielle qui consiste à redécouvrir le vieux monde oublié depuis la grande maladie. Electre 2019<br />
	</p>
	</div>
...
<h2>&nbsp;0 exemplaire(s) disponible(s) sur 1</h2>
...
Médiathèque José Cabanis</a>
				...
				<td class="holdingslistbab">
					...
					24/1/2020&nbsp;
						...
						<a href="/web2/tramp2.exe/goto/A02plcce.001?screen=SubmitRequest_CAB.html&server=1home&item=1&item_source=1home">	<img src="/html/BMT1_iFiles/Graphics/babelio/reserver.gif" alt="Réserver ce titre"></a>
...
<a target="_blank" href="http://catalogue.univ-toulouse.fr/ipac20/ipac.jsp?profile=&menu=search&aspect=subtab26&npp=10&ipp=20&spp=20&profile=sicd&ri=&index=ISBN2&term=9782355743535&x=0&y=0&aspect=subtab26">
<img border="0" SRC="/html/BMT1_iFiles/Graphics/babelio/bt_archipel.gif" alt="Archipel">
										</a>
<a target="_blank" href="http://www.sudoc.abes.fr/DB=2.1/CMD?ACT=SRCHA&IKT=7&SRT=RLV&TRM=9782355743535">
...
<img border="0" SRC="/html/BMT1_iFiles/Graphics/babelio/bt_googlebooksearch.gif" alt="Google Book Search">
	...
	<td>
										...
										<FORM NAME="VOPT" ACTION="/web2/tramp2.exe/see_record/A02plcce.001&server=1home&item=1&item_source=1home" METHOD="post">
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=TI&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Stand+still+stay+silent&screen=hitlist.html">Stand still stay silent 1 / Minna Sundberg</a></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Sundberg%2C+Minna&screen=hitlist.html">Sundberg, Minna</a></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><span class="bold">978-2-35574-353-5 (cart.) 29 EUR<br /></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold">Talence (Gironde) : Akileos, 2018<br /></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold">1 vol. (320 p.) : illustrations en couleur ; 26 x 19 cm<br /></span>
		</td>
	</tr>
	...
	<tr>
		<th class="defaultstyle_pk">
			<strong>Note g&eacute;n&eacute;rale&nbsp;:</strong>
		</th>

		<td class="contenu_pk">
			<span class="bold">Traduit de l'anglais<br /></span>
		</td>
	</tr>
		...
		<td class="contenu_pk">
			<span class="bold">Une équipe d'explorateurs nordiques se lance dans la première mission officielle qui consiste à redécouvrir le vieux monde oublié depuis la grande maladie. Electre 2019<br /></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Bande+dessin%E9e&screen=hitlist.html">Bande dessinée</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Comics&screen=hitlist.html">Comics</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A02plcce.001?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=&query=Fantastique&screen=hitlist.html">Fantastique</a><BR /> </span>
	...
	<tr>
		<th class="defaultstyle_pk">
			<strong>Contenu dans :</strong>
		</th>

		<td class="contenu_pk">
			<span class="bold">Stand still stay silent ; 1<br /></span>
		</td>
	</tr>
