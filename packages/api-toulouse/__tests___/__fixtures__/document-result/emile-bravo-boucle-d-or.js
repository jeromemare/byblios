...
<META HTTP-EQUIV="REFRESH" CONTENT="500 ;URL=/web2/tramp2.exe/log_out/A01cte0g.002?server=1home&item=1&item_source=1home">
...
<div class="surbandeau">
		<div class="conteneur">
		<a class="home" href="/web2/tramp2.exe/goto/A01cte0g.002?screen=Home.html">
		</a>
		...
		<div class="recherche">
			<form class="quicksearch" name="QEntry" action="/web2/tramp2.exe/form/A01cte0g.002" METHOD="post" enctype="application/x-www-form-urlencoded">
				<span>
				<input type="hidden" name="servers" value="1home">
				<input type="hidden" name="query_screen" value="Home.html">
				<input class="requete" placeholder="Rechercher dans le catalogue" type="text" size="28" maxlength="255" name="query" size="30" value="Boucle d'or et les sept">
...
<INPUT TYPE=SUBMIT NAME="recherche_bandeau" class=topsearch VALUE="">
	...
	<div class="mmenu">
		<div class="mmenu-conteneur">
				<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=PowerSearch.html">
					<span>
					Recherche avancée
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=ALL_New.html">
					<span>
					Nouveautés
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=ALL_have_read.html">
					<span>
					Sélections
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=ALL_oeil.html">
					<span>
					Handicap
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=Ress_Num.html">
					<span>
					24H/24H
					</span>
				</a>
				...
				<a class="moncompte" href="/web2/tramp2.exe/goto/A01cte0g.002?screen=MyAccount.html">
					<span>
					Mon compte
					</span>
				</a>
...
<tbody><tr><td align="center">
			...
			<img src="/html/BMT1_iFiles/Graphics/babelio/arrow_left_2.gif" alt="" border="0">



					<A HREF="/web2/tramp2.exe/see_hits/A01cte0g.002?server=1home#1">

					<img src="/html/BMT1_iFiles/Graphics/babelio/refresh.gif" alt="Voir la liste" hspace="2" border="0"></a>

<a href="/web2/tramp2.exe/get_query/A01cte0g.002"><img src="/html/BMT1_iFiles/Graphics/babelio/lupe.gif" alt="Modifier la Recherche" border="0"></a>


			<a href="/web2/tramp2.exe/see_record/A01cte0g.002?server=1home&item=2" >
...
<div id="isbn_livre">
<span style="display:none;">9782020620185</span>
</div>
...
<!-- TITELIVE-->
	...
	<!--<img src="http://images.titelive.com/185/9782020620185_1_75.jpg" width="200"  border="0" align="center" style="border: 1px solid #cccccc; padding: 5px;"><br>-->
...
<a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Bravo%2C+Emile" onMouseOver="window.status='Recherche par auteur'; return true">
<img src="/html/BMT1_iFiles/Graphics/babelio/search_auteur.gif" alt="du meme auteur" border="0"></a>
	  ...
	  <input name="" type="text" value="http://catalogues.toulouse.fr/web2/tramp2.exe/do_keyword_search/log_in?setting_key=BMT1&servers=1home&query=2004030814&screen=hitlist.html">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	Boucle d'or et les sept ours nains /<br>

	</h1>

	<div id="auteur">de <a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Bravo%2C+Emile&screen=hitlist.html">Bravo, Emile</a>
...
<h2>&nbsp;6 exemplaire(s) disponible(s) sur 10</h2>
...
Médiathèque Danièle Damin</a>
				...
				<td class="holdingslistbab">
					...
					29/1/2020&nbsp;
						...
						<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=SubmitRequest_DAU.html&server=1home&item=1&item_source=1home">	<img src="/html/BMT1_iFiles/Graphics/babelio/reserver.gif" alt="Réserver ce titre"></a>
...
<a target="_blank" href="https://www.bibliotheque.toulouse.fr/bibliotheques/reseau-des-bibliotheques-de-quartier/bibliotheque-pont-des-demoiselles/">

Bibliothèque Pont des demoiselles</a>
					</td>
...
Médiathèque Empalot</a>
				...
				<td class="holdingslistbab">
					...
					28/1/2020&nbsp;
						...
						<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=SubmitRequest_EMP.html&server=1home&item=1&item_source=1home">	<img src="/html/BMT1_iFiles/Graphics/babelio/reserver.gif" alt="Réserver ce titre"></a>
...
Médiathèque Fabre</a>
				...
				<td class="holdingslistbab">
					...
					5/2/2020&nbsp;
						...
						<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=SubmitRequest_FAB.html&server=1home&item=1&item_source=1home">	<img src="/html/BMT1_iFiles/Graphics/babelio/reserver.gif" alt="Réserver ce titre"></a>
...
Fonds de conservation jeunesse</a>
					</td>
            ...
            Consultation sur place - Communiqué sur demande&nbsp;

          </td>

				<td class="holdingslistbab">
				Magasin Fonds de conservation jeunesse&nbsp;
				</td>
				...
				<td class="holdingslistbab">
										...
										<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=Magasin_FCJ_RS.html&server=1home&item=1&item_source=1home">	<img  SRC="/html/BMT1_iFiles/Graphics/magasinbab.gif" ALT="consultation périgord"></a>
...
Médiathèque Serveyrolles</a>
				...
				<td class="holdingslistbab">
					...
					25/1/2020&nbsp;
						...
						<a href="/web2/tramp2.exe/goto/A01cte0g.002?screen=SubmitRequest_SER.html&server=1home&item=1&item_source=1home">	<img src="/html/BMT1_iFiles/Graphics/babelio/reserver.gif" alt="Réserver ce titre"></a>
...
<a target="_blank" href="http://catalogue.univ-toulouse.fr/ipac20/ipac.jsp?profile=&menu=search&aspect=subtab26&npp=10&ipp=20&spp=20&profile=sicd&ri=&index=ISBN2&term=9782020620185&x=0&y=0&aspect=subtab26">
<img border="0" SRC="/html/BMT1_iFiles/Graphics/babelio/bt_archipel.gif" alt="Archipel">
										</a>
<a target="_blank" href="http://www.sudoc.abes.fr/DB=2.1/CMD?ACT=SRCHA&IKT=7&SRT=RLV&TRM=9782020620185">
...
<img border="0" SRC="/html/BMT1_iFiles/Graphics/babelio/bt_googlebooksearch.gif" alt="Google Book Search">
	...
	<td>
										...
										<FORM NAME="VOPT" ACTION="/web2/tramp2.exe/see_record/A01cte0g.002&server=1home&item=1&item_source=1home" METHOD="post">
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=TI&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Boucle+d%27or+et+les+sept+ours+nains+%2F&screen=hitlist.html">Boucle d'or et les sept ours nains / Emile Bravo</a></span>
	...
	<tr>
		<th class="defaultstyle_pk">
			<strong>Autre variante du titre&nbsp;:</strong>
		</th>

		<td class="contenu_pk">

			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=TI&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Version+de+%22Boucle+d%27or%22&screen=hitlist.html">Version de "Boucle d'or"</a><br /></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=AU&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Bravo%2C+Emile&screen=hitlist.html">Bravo, Emile</a></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><span class="bold">2-02-062018-9 (Cart.) : 9.00 EUR<br /></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold">Paris : Seuil Jeunesse, 2004<br /></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold">26 p. : ill. en coul. ; 18 x 25 cm<br /></span>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="contenu_pk">
			...
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=SER&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=bande+des+petits&screen=hitlist.html">La bande des petits</a><br /></span>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Bande+dessin%E9e+pour+les+jeunes&screen=hitlist.html">Bande dessinée pour les jeunes</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Conte+pour+les+jeunes&screen=hitlist.html">Conte pour les jeunes</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Parodie&screen=hitlist.html">Parodie</a><BR /> </span>
	...
	<tr>
		...
		<td class="contenu_pk">
			<span class="bold"><a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Ours&screen=hitlist.html">Ours</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Sommeil&screen=hitlist.html">Sommeil</a><BR /> <a href="/web2/tramp2.exe/do_keyword_search/A01cte0g.002?servers=1home&index=&material_filter=all&language_filter=all&location_filter=all&location_group_filter=ALL&date_filter=all&query=Prince&screen=hitlist.html">Prince</a><BR /> </span>
