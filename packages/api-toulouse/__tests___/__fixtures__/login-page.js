...
<TITLE>Ouverture d'une session Web2</title>
<META HTTP-EQUIV="REFRESH" CONTENT="500 ;URL=/web2/tramp2.exe/log_out/TEST_ID.000">

</head>


<BODY onLoad="document.loginWN.userid.focus()" >
<div class="centrage"><div class="total">
...
<div class="surbandeau">
		<div class="conteneur">
		<a class="home" href="/web2/tramp2.exe/goto/TEST_ID.000?screen=Home.html">
		</a>
		...
		<div class="recherche">
			<form class="quicksearch" name="QEntry" action="/web2/tramp2.exe/form/TEST_ID.000" METHOD="post" enctype="application/x-www-form-urlencoded">
				<span>
				<input type="hidden" name="servers" value="1home">
				<input type="hidden" name="query_screen" value="Home.html">
				<input class="requete" placeholder="Rechercher dans le catalogue" type="text" size="28" maxlength="255" name="query" size="30" value="">
...
<INPUT TYPE=SUBMIT NAME="recherche_bandeau" class=topsearch VALUE="">
	...
	<div class="mmenu">
		<div class="mmenu-conteneur">
				<a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=PowerSearch.html">
					<span>
					Recherche avancée
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=ALL_New.html">
					<span>
					Nouveautés
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=ALL_have_read.html">
					<span>
					Sélections
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=ALL_oeil.html">
					<span>
					Handicap
					</span>
				</a>
				<a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=Ress_Num.html">
					<span>
					24H/24H
					</span>
				</a>
				...
				<a class="moncompte" href="/web2/tramp2.exe/goto/TEST_ID.000?screen=MyAccount.html">
					<span>
					Mon compte
					</span>
				</a>
...
<FORM NAME="loginWN" ACTION="/web2/tramp2.exe/login_when_needed/TEST_ID.000" METHOD="POST" ENCTYPE="application/x-www-form-urlencoded">
<INPUT TYPE="hidden" NAME="fail_screen" VALUE="LoginOTFFailed.html">
<INPUT TYPE="hidden" NAME="screen" VALUE="MyAccount.html">
<INPUT TYPE="hidden" NAME="server" VALUE="">
<INPUT TYPE="hidden" NAME="item" VALUE="">
<INPUT TYPE="hidden" NAME="item_source" VALUE="">
...
<table cellSpacing="0" cellPadding="0" class="defaultstyle" width="80%" align="center">
	<tr>
		<td class="enrichcontent" 	>
			<h1>Depuis le 28 Mai 2019 : problème d'envoi de mels </h1>
		</td>
	</tr>
	<tr>
		<td class="enrichcontent" align="center">
<u>Du 28 mai au 5 Juin, les envois de mels, sms, courriers ont été perturbés.</u>
<br>N'hésitez pas à vérifier l'état de votre compte sur notre catalogue.<br><br>
<u>Depuis le 5 Juin, l'envoi de mels n'est toujours pas rétabli.<br></u>
Vous êtes avisés de vos réservations : par sms ou par courrier papier.<br>
Vous êtes avisés de vos retards : par sms ou par courrier papier : 7 jours après la date de retour prévue<br><br>
Vous remerciant pour votre compréhension.		</td>
	</tr>
</table>
<table>
	<tr>
	...
	<tr>
  		<td>
			<table cellSpacing="0" cellPadding="0"     >
				<tr>
					<td class="enrichheader">Ouvrir la session</td>
				</tr>
       	  		<tr>
	   				<td class="enrichcontent">Pour consulter votre dossier, tapez votre num&eacute;ro d'abonné.</td>
	  			</tr>
					<td class="gatewaystyle">
					<table cellSpacing="0" cellPadding="0"    align="center" >
   						<tr>
    							<td class="defaultstyle" ><label for="user_id">Num&eacute;ro d'abonné&nbsp;:</label>
							</td>
    							<td class="defaultstyle" >
 								<INPUT NAME="userid" VALUE="0017000xxxxxxx" MAXLENGTH="250" SIZE="20">
							</td>
  						</tr>
   						<!--<tr>
    							<td class="defaultstyle" >
      							<strong>ou&nbsp;</strong>
      							<label for="alt_id">Autre num&eacute;ro&nbsp;:</label>
							</td>
    							<td class="defaultstyle"  >
      							<INPUT NAME="alt_user_id" id="alt_id" VALUE="" MAXLENGTH="250" SIZE="20">
							</td>
    						</tr>-->
    						<tr>
      						<td class="defaultstyle" >
								<label for="pin">Mot de passe (NIP) : </label>
							</td>
      						<td class="defaultstyle"  >
       							<input type="password" name="pin" id="pin" VALUE="" maxlength="250" size="20">(*)
	  						</td>
    						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<td class="defaultstyle" align="center">
	   					<input type="submit" value="Ouvrir la session" class="searchbutton">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" value="Effacer/Annuler" class="searchbutton">
	     				</td>
				</tr>
												<tr><td align="center">...</td></tr>

					<tr>
				<td align="center">(*) <i>Mot de passe oublié ?</i> <a href="/web2/tramp2.exe/goto/TEST_ID.000?screen=NIP_perdu.html">Cliquez ici.</a><td>
				</tr>
